...
- Your project is open source and already uses a copyleft-compatible license.
- You are building an internal tool with no external distribution or network exposure.
- You are evaluating sealchain before committing to a license.
...
sealchain is maintained by [Parallel Hours LLC](https://parallelhours.com). Dual licensing keeps the library freely available for open source use while ensuring that companies building proprietary products on top of it contribute back — either by open-sourcing their work or by supporting continued development through a commercial license.
